...
;; Maintainer: Joakim G.
;; Version: 1.0
;; Package-Requires: ((emacs "28.1") (gptel "0.8") (spinner "1.7.4"))
...
;;
;; Provides these non-mutating commands:
;;
;; * gptx-review
...
;;
;; Provides these mutating commands:
;;
;; * gptx-change
...
(require 'subr-x) ; runtime: string-trim, string-empty-p
(require 'cl-lib)
(require 'auth-source)
(require 'gptel)
(require 'spinner)  ; GNU ELPA, not core
